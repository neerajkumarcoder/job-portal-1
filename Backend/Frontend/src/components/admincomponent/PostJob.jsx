    ...
    <div>
      ...
      <div className="flex items-center justify-center w-full my-5 px-4 sm:px-6 lg:px-8">
        <form
          ...
          className="p-4 sm:p-6 md:p-8 w-full max-w-4xl border border-gray-500 shadow-sm hover:shadow-xl hover:shadow-red-300 rounded-lg"
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
            <div>
              ...
              <Input
                ...
                className="w-full focus-visible:ring-offset-0 focus-visible:ring-0 my-1 hover:shadow-blue-400"
